    ...
    >
      ...
      >
          ...
          <div className="relative">
            <div className="w-full font-large break-words transition-opacity duration-200 min-h-[1.5rem]">
              <textarea
                ...
                placeholder={
                  isConnected ? "오늘 어떤 도움을 드릴까요? (무제한 입력 가능)" : "서버 연결 중..."
                }
        ...
        {uploadedFiles.length > 0 && (
          <div className="overflow-hidden rounded-b-2xl" style={{ height: "auto" }}>
                    ...
                    >
                      <div className="relative flex flex-col gap-1 min-h-0">
                        <h3 
                          ...
                          style={{ opacity: 1, color: "hsl(var(--text-100))" }}
                        >
                          {file.fileName}
                        </h3>
                        <p 
                          className="text-[10px] line-clamp-1 tracking-tighter break-words text-text-500"
                          style={{ opacity: 1, color: "hsl(var(--text-500))" }}
                        >
                          {file.pageCount ? `${file.pageCount}페이지` : `${Math.ceil(file.fileSize / 1024)}KB`}
                        </p>
                      </div>
