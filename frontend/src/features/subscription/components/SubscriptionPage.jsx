...
const SubscriptionPage = () => {
  ...
  const [selectedEngine, setSelectedEngine] = useState('T5');

  useEffect(() => {
    const loadUserInfo = () => {
      try {
        const storedUserInfo = localStorage.getItem('userInfo');
        const storedEngine = localStorage.getItem('selectedEngine') || 'T5';
  ...
  const testimonials = [
    {
      name: '김지연',
      role: '콘텐츠 마케터',
      comment: 'T5 엔진으로 생성한 제목의 클릭률이 평균 35% 상승했습니다. 정말 놀라운 도구예요.',
      plan: '베이직 플랜'
    },
    {
      name: '박민수',
      role: '디지털 에디터',
      comment: 'H8 엔진의 창의적인 제목 생성 능력이 인상적입니다. 업무 효율이 3배 향상되었어요.',
      plan: '프리미엄 플랜'
    },
    {
      name: '이소영',
      role: '프리랜서 작가',
      comment: '무료 플랜만으로도 충분히 유용합니다. 특히 빠른 아이디어 도출에 큰 도움이 됩니다.',
      plan: '무료 플랜'
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-5xl mx-auto px-6 lg:px-8">
        ...
        <div className="pt-20 pb-32 text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-slate-100 text-slate-700 px-4 py-2 rounded-full text-sm font-medium mb-8">
              ...
              <span>AI 기반 제목 생성 서비스</span>
            </div>
            
            <h1 className="text-6xl lg:text-7xl font-bold text-slate-900 mb-8 tracking-tight leading-[1.1]">
              완벽한 제목을
              <br />
            ...
            <p className="text-xl lg:text-2xl text-slate-600 max-w-3xl mx-auto leading-relaxed mb-16 font-light">
              T5와 H8 엔진으로 클릭률을 높이는 매력적인 제목을
              <br className="hidden sm:block" />
              <span className="text-slate-900 font-medium">빠르고 정확하게</span> 생성하세요
            </p>
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 lg:gap-16 text-slate-500">
              <div className="flex items-center gap-3 bg-white/60 backdrop-blur-sm px-4 py-3 rounded-full border border-slate-200/50">
                ...
                <span className="font-medium text-slate-700">10,000+ 사용자</span>
              </div>
              <div className="flex items-center gap-3 bg-white/60 backdrop-blur-sm px-4 py-3 rounded-full border border-slate-200/50">
                <Shield className="w-5 h-5 text-slate-600" />
                <span className="font-medium text-slate-700">14일 무료 체험</span>
              </div>
              <div className="flex items-center gap-3 bg-white/60 backdrop-blur-sm px-4 py-3 rounded-full border border-slate-200/50">
                <Clock className="w-5 h-5 text-slate-600" />
                <span className="font-medium text-slate-700">24시간 지원</span>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="mb-32">
          <div className="text-center mb-20">
            ...
            <p className="text-xl lg:text-2xl text-slate-600 max-w-4xl mx-auto font-light leading-relaxed">
              클릭률을 높이는 매력적인 제목으로 콘텐츠의 가치를 극대화하세요
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-10 mb-20">
            ...
            >
              ...
              <p className="text-slate-600 leading-relaxed text-lg">
                ...
                콘텐츠의 핵심을 정확히 반영하는 제목을 생성합니다. 
                <span className="font-semibold text-slate-900">SEO 최적화</span>와 가독성을 동시에 고려합니다.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-slate-600 leading-relaxed text-lg">
                ...
                <span className="font-semibold text-slate-900">감성적 어필</span>로 
                독자의 관심을 끄는 매력적인 제목을 만듭니다. 트렌드를 반영한 최신 스타일을 제공합니다.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-slate-600 leading-relaxed text-lg">
                제목 작성 시간을 <span className="font-semibold text-slate-900">90% 단축</span>하고{' '}
                <span className="font-semibold text-slate-900">클릭률은 35% 향상</span>시킵니다. 
                다양한 옵션 중 최적의 제목을 선택할 수 있습니다.
              </p>
            </motion.div>
          </div>
        </div>
            ...
            {plans.map((plan, index) => (
              ...
              >
                ...
                <div className="text-center mb-10">
                  ...
                  <p className="text-slate-600 mb-8 leading-relaxed text-base px-2 whitespace-pre-line">{plan.description}</p>
                  ...
                  <div className="mb-8">
                    ...
                    <div className="text-3xl lg:text-4xl font-bold text-slate-900 text-center whitespace-nowrap">
                      {plan.price}
                      {plan.price !== '무료' && (
                        <span className="text-lg text-slate-600 ml-1">/월</span>
                      )}
                    </div>
                  </div>
                  
                  <div className="text-slate-500 mb-10 text-base">
                ...
                <button
                  ...
                  className={`w-full py-5 px-8 rounded-2xl font-semibold text-lg transition-all duration-300 ${
                    plan.id === currentPlan
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-slate-200">
                  {[
                    ...
                    { feature: 'T5 엔진', free: '기본', basic: '고급', premium: '전문가급' },
                    { feature: 'H8 엔진', free: '기본', basic: '고급', premium: '전문가급' },
                    { feature: '제목 생성 수', free: '5개', basic: '무제한', premium: '무제한' },
        ...
        {/* CTA Section */}
        <div className="text-center bg-gradient-to-br from-slate-900 to-slate-800 rounded-[2rem] p-16 mb-20 shadow-2xl">
          <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6">
            지금 시작해보세요
          </h2>
          <p className="text-xl text-slate-300 mb-12 max-w-2xl mx-auto font-light">
            AI 제목 생성으로 당신의 콘텐츠를 더욱 매력적으로 만들어보세요
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-lg mx-auto">
            <button
              onClick={() => handleUpgrade('basic')}
              className="bg-white text-slate-900 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-slate-100 transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
              14일 무료 체험 시작
            </button>
            <button
              onClick={() => handleUpgrade('free')}
              className="border-2 border-white/80 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:bg-white hover:text-slate-900 transition-all duration-300 transform hover:scale-105"
            >
              무료로 시작하기
            </button>
          </div>
