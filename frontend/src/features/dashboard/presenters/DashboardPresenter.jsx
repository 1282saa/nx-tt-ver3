  ...
  >
    ...
    <ResponsiveContainer width="100%" height={300}>
      <AreaChart data={data}>
        ...
        <Legend />
        <Area type="monotone" dataKey="T5" stroke="hsl(251, 40.2%, 54.1%)" fillOpacity={1} fill="url(#colorT5)" strokeWidth={2} />
        <Area type="monotone" dataKey="H8" stroke="hsl(210, 70.9%, 51.6%)" fillOpacity={1} fill="url(#colorH8)" strokeWidth={2} />
      </AreaChart>
    </ResponsiveContainer>
  </motion.div>
);
  ...
  >
    ...
    <ResponsiveContainer width="100%" height={300}>
      <RadarChart data={data}>
        ...
        <Radar name="T5" dataKey="T5" stroke="hsl(251, 40.2%, 54.1%)" fill="hsl(251, 40.2%, 54.1%)" fillOpacity={0.3} strokeWidth={2} />
        <Radar name="H8" dataKey="H8" stroke="hsl(210, 70.9%, 51.6%)" fill="hsl(210, 70.9%, 51.6%)" fillOpacity={0.3} strokeWidth={2} />
        <Legend />
      </RadarChart>
    </ResponsiveContainer>
  </motion.div>
...
const UsageOverviewSection = ({ usageData }) => (
  ...
  >
    <EngineUsageCard engine="T5" data={usageData.T5} color="hsl(251, 40.2%, 54.1%)" />
    <EngineUsageCard engine="H8" data={usageData.H8} color="hsl(210, 70.9%, 51.6%)" />
  </motion.div>
);
