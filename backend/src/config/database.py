...
TABLES = {
    'conversations': {
        'name': os.environ.get('CONVERSATIONS_TABLE', 'nexus-conversations'),
    ...
    'prompts': {
        'name': os.environ.get('PROMPTS_TABLE', 'nexus-prompts'),
    ...
    'usage': {
        'name': os.environ.get('USAGE_TABLE', 'nexus-usage'),
        'partition_key': 'userId',
    ...
    'websocket_connections': {
        'name': os.environ.get('WEBSOCKET_TABLE', 'nexus-websocket-connections'),
