...
FUNCTION_NAME="ConversationHandler"
REGION="ap-northeast-2"
ROLE_NAME="LambdaConversationRole"
RUNTIME="python3.9"
DEPLOYMENT_DIR="lambda/deployments/conversation"

echo "🚀 Starting Lambda function deployment for Conversation Handler"
        ...
        "Statement": [
            {
                ...
                "Resource": [
                    ...
                    "arn:aws:dynamodb:'$REGION':*:table/Conversations/index/*"
                ]
            }
        ]
    }' \
...
aws lambda create-function \
    ...
    --timeout 30 \
    --memory-size 256 \
    --environment Variables={CONVERSATIONS_TABLE=Conversations} \
    --region $REGION 2>/dev/null
